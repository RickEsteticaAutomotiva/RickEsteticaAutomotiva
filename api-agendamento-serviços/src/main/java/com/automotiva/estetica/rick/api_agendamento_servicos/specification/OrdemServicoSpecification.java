    ...
    public static Specification<OrdemServicoEntity> filtroUnico(String filtro) {
        return (root, query, cb) -> {
            ...
            return cb.or(
                    ...
                    cb.like(cb.lower(
                            cb.function("TO_CHAR", String.class, root.get("dataAgendamento"), cb.literal("yyyy-MM-dd HH24:MI"))
                    ), likeFiltro),
                    cb.like(cb.lower(
                            cb.function("TO_CHAR", String.class, root.get("dtConclusao"), cb.literal("yyyy-MM-dd HH24:MI"))
                    ), likeFiltro),
