 ...
 * 
 * <p>Extrai o username (email) do JWT e mapeia para o ID da pessoa no banco de dados.
 * 
...
public class SecurityUtils {
     ...
     * @throws AcessoNegadoException se nenhum usuário estiver autenticado
     */
    public Long obterIdUsuarioAutenticado() {
        ...
        return pessoaRepositoryPort.buscarPorEmail(email)
                .map(pessoa -> pessoa.getId())
                .orElseThrow(() -> AcessoNegadoException.builder()
                        .mensagem("usuário autenticado não encontrado no sistema")
                        .detalhes("")
                        .build());
    }
