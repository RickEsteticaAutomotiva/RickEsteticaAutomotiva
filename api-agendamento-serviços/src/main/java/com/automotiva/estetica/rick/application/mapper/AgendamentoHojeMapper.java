...
public interface AgendamentoHojeMapper {
    ...
    default AgendamentoHojeResponse toResponseWithCalculations(
            OrdemServico ordemServico,
            List<ItemServico> itens) {

        List<AgendamentoHojeServicoResponse> servicos = itens.stream()
                .map(this::servicoToResponse)
                .toList();
        ...
        AgendamentoHojeResponse response = AgendamentoHojeResponse.builder()
                ...
                .precoMinimo(ordemServico.getPrecoMinimo())
        ...
        if (ordemServico.getVeiculo() != null && ordemServico.getVeiculo().getPessoa() != null) {
            response.setCliente(
                    com.automotiva.estetica.rick.application.dto.response.AgendamentoHojeClienteResponse.builder()
                            ...
                            .telefone(ordemServico.getVeiculo().getPessoa().getTelefone())
                            .build());
        }
        ...
        if (ordemServico.getVeiculo() != null) {
            response.setVeiculo(
                    com.automotiva.estetica.rick.application.dto.response.AgendamentoHojeVeiculoResponse.builder()
                            ...
                            .ano(ordemServico.getVeiculo().getAno())
                            .cor(ordemServico.getVeiculo().getCor())
                            .build());
        }
    ...
    default AgendamentoHojeServicoResponse servicoToResponse(ItemServico itemServico) {
        return AgendamentoHojeServicoResponse.builder()
                .id(itemServico.getServico().getId())
                .nome(itemServico.getServico().getNome())
                .descricao(itemServico.getServico().getDescricao())
                .preco(itemServico.getPreco())
                .build();
    }
}
