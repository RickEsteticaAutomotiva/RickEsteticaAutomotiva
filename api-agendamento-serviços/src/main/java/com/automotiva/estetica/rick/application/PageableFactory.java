...
/**
 * Utilitário de paginação da camada de aplicação. Centraliza a construção do Pageable a partir do
 * PageRequest customizado, eliminando o bloco duplicado presente em múltiplos services.
 */
public final class PageableFactory {
    ...
    /**
     * Constrói um {@link Pageable} a partir do {@link PageRequest} da aplicação. Se o campo
     * ordenarPor não for informado, ordena por "id" como padrão.
     *
