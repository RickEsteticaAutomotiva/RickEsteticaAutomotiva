 ...
 *
 * <p>O campo {@code roles} precisa de conversão explícita porque o tipo no domínio
 * é {@code Set<RoleEnum>} enquanto na entidade JPA é {@code Set<RoleJpaEntity>}.
 *
...
public interface PessoaPersistenceMapper {
     ...
     *
     * <p>O campo {@code roles} é ignorado aqui: a associação ManyToMany com
     * {@link RoleJpaEntity} é resolvida no {@code PessoaRepositoryAdapter},
     * que busca as entidades reais pelo {@code RoleJpaRepository} antes de salvar.
     * Isso evita a criação de registros duplicados na tabela {@code role}.
     */
