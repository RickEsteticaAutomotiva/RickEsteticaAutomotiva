 ...
 *
 * <p>Package-private: utilizado apenas pelo {@code PessoaRepositoryAdapter} dentro do mesmo pacote,
 * sem exposição para as camadas superiores.
 *
...
public interface RoleJpaRepository extends JpaRepository<RoleJpaEntity, Long> {
    ...
    /**
     * Busca uma role pelo seu enum, ex.: {@code findByNome(RoleEnum.ROLE_USER)}. Retorna {@link
     * Optional#empty()} se a role ainda não existir no banco.
     */
